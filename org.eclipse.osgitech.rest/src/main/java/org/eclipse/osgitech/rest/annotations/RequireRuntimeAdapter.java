...
public @interface RequireRuntimeAdapter {
	...
	public static final String JAKARTA_REST_JERSEY_ADAPTER = "org.eclipse.osgitech.rest.adapter";
	public static final String JAKARTA_REST_JERSEY_ADAPTER_VERSION = "2.0.0";
